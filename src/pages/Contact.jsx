...
export default function Contact() {
  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="bg-[#FAF7F0] border-b border-[#EAE4D7] py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <span className="text-xs uppercase tracking-widest text-[#5e7a45] font-semibold bg-[#7a9660]/15 px-3 py-1 rounded-full">
            Connect With Us & Admissions
          </span>
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-[#1F291E]">
            Contact & Admission Journey
          </h1>
          <p className="font-serif italic text-2xl sm:text-3xl text-[#2C4A2E]">
            The Journey to MINDFL — A Thoughtful Path to Joining our Community
          </p>
      ...
      {/* The Four Stages of Connection (PDF Page 20) */}
      ...
      {/* Slidable Image Gallery: Student's Artworks (Placed before Newsletter / Inquiry section) */}
      <ArtworkGallery />

      {/* Interactive Expression of Interest Form Component */}
